import pandas as pd
class MetricWorkerUnemploymentRate():
    def __init__(self):
    ...
    def clean_data(self):
        ...
        self.bronze_pd['clean_unemployment_rate'] = self.bronze_pd[change_col]
        print('bye')

    def silver_data(self):
        self.silver_pd = self.bronze_pd[['clean_date', 'clean_unemployment_rate']]